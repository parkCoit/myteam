...
label_path = './label/what_spell_2.txt'
    ...
    with open(label_path, 'r') as f:
        ...
        for i in range(len(labels)):
            if labels[i] == 'ghost':
                ...
                labels[i] = 2
            elif labels[i] == 'exhaust':
                labels[i] = 3
            elif labels[i] == 'clarity':
                labels[i] = 4
            elif labels[i] == 'teleport':
                labels[i] = 5
            elif labels[i] == 'flash':
                labels[i] = 6
            elif labels[i] == 'smite':
                labels[i] = 7
            elif labels[i] == 'ignite':
                labels[i] = 8
            elif labels[i] == 'cleanse':
                labels[i] = 9
        labels = labels[:200]
...
model.save('D:/PycharmProjects/TeamProject/app/models/model_save/what_spell_2.h5')